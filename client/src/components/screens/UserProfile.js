...
const [showfollow,setShowFollow] = useState(true)
    ...
    const followUser = ()=>{
        ...
        .then(data=>{
            console.log(data)
            dispatch({type:"UPDATE",payload:{follwoing:data.following,followers:data.followers}})
        ...
        {userProfile ? <div style={{maxWidth:"550px",margin:"0px auto"}}>
           <div style={{display:"flex",justifyContent:"space-around",margin:"18px 0px",borderBottom:"1px solid grey"}}>
               ...
               <div>
                   ...
                   {showfollow?<button style={{margin:"10px"}}  className="btn waves-effect waves-light blue darken-1" onClick={()=>followUser()}>Follow</button>
                   :
